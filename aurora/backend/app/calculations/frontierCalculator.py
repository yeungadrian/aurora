...
def efficient_return(fund_returns, fund_covariance, target):
    ...
    initial_weights = num_funds*[1./num_funds,]
    result = minimize(portfolio_std, initial_weights , args=args, method='SLSQP', bounds=bounds,      constraints=constraints).x
...
def efficient_frontier_metrics(fund_returns, fund_covariance, portfolios, fund_codes):
    ...
    efficient_portfolios = calculate_efficient_frontier(fund_returns,fund_covariance, portfolios)
